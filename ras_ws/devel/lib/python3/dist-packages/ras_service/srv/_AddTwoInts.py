...
"""autogenerated by genpy from ras_service/AddTwoIntsRequest.msg. Do not edit."""
import codecs
import sys
...
class AddTwoIntsRequest(genpy.Message):
  ...
  _type = "ras_service/AddTwoIntsRequest"
...
def _get_struct_2q():
    ...
    return _struct_2q
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from ras_service/AddTwoIntsResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class AddTwoIntsResponse(genpy.Message):
  _md5sum = "51c6be16de0582cf6eb0cd86b87dd80d"
  _type = "ras_service/AddTwoIntsResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """int64 suma
"""
  __slots__ = ['suma']
  _slot_types = ['int64']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.suma,) = _get_struct_q().unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
...
class AddTwoInts(object):
  _type          = 'ras_service/AddTwoInts'
  _md5sum = '35e98de862a014b3b63dfc10ab785a0e'
