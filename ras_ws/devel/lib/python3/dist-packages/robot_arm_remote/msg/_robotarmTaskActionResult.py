...
"""autogenerated by genpy from robot_arm_remote/robotarmTaskActionResult.msg. Do not edit."""
import codecs
import sys
...
class robotarmTaskActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "robot_arm_remote/robotarmTaskActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_arm_remote/robotarmTaskResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(robotarmTaskActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = robot_arm_remote.msg.robotarmTaskResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot_arm_remote.msg.robotarmTaskResult()
