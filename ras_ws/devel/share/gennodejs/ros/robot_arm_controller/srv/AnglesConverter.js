...
// (in-package robot_arm_controller.srv)
...
class AnglesConverterRequest {
  ...
  static datatype() {
    ...
    return 'robot_arm_controller/AnglesConverterRequest';
  }
...
class AnglesConverterResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robot_arm_controller/AnglesConverterResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'robot_arm_controller/AnglesConverter'; }
};
